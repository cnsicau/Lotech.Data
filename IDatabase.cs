...
namespace Lotech.Data
{
    ...
    public interface IDatabase
    {
        ...
        /// <returns></returns>
        DbType ParseDbType(Type propertyType);
        /// <summary>
        /// 添加指定方向的参数
        /// </summary>
        ...
        /// <summary>
        /// 获取参数名称，如SQL Server的 [Create]，则返回 Create
        /// </summary>
        /// <param name="name"></param>
        /// <returns></returns>
        ...
        bool Exists<EntityType>(object id);
        ...
        /// <returns></returns>
        bool Exists<EntityType>(Expression<Func<EntityType, bool>> conditions);
        #endregion
        ...
        IEnumerable<EntityType> ExecuteEntities<EntityType>(DbCommand command);
        /// <summary>
        /// 执行返回指定实体
        /// </summary>
        /// <typeparam name="EntityType">实体类型</typeparam>
        ...
        /// <param name="commandText">命令文本</param>
        /// <returns>返回可枚举的实体集合</returns>
        IEnumerable<EntityType> ExecuteEntities<EntityType>(CommandType commandType, string commandText);
        /// <summary>
        /// 执行返回指定实体
        /// </summary>
        /// <typeparam name="EntityType">实体类型</typeparam>
        ...
        /// <param name="commandText">命令文本</param>
        /// <returns>返回可枚举的实体集合</returns>
        IEnumerable<EntityType> ExecuteEntities<EntityType>(string commandText);
        #endregion
        ...
        void InsertEntity<EntityType>(EntityType entity);
        /// <summary>
        /// 批量创建实体（INSERT）
        /// </summary>
        /// <typeparam name="EntityType"></typeparam>
        /// <param name="entities"></param>
        void InsertEntities<EntityType>(IEnumerable<EntityType> entities);
        ...
        /// <typeparam name="EntityType"></typeparam>
        /// <param name="entity"></param>
        void UpdateEntity<EntityType>(EntityType entity);
        ...
        /// <typeparam name="EntityType"></typeparam>
        /// <param name="entity"></param>
        /// <param name="originalEntity">返回原实体</param>
        void UpdateEntity<EntityType>(EntityType entity, out EntityType originalEntity);
        /// <summary>
        /// 批量更新
        /// </summary>
        /// <typeparam name="EntityType"></typeparam>
        /// <param name="entities"></param>
        void UpdateEntities<EntityType>(IEnumerable<EntityType> entities);
        /// <summary>
        /// 批量更新
        /// </summary>
        /// <typeparam name="EntityType"></typeparam>
        /// <param name="entities"></param>
        /// <param name="originalEntities">返回更新前的实体集合</param>
        void UpdateEntities<EntityType>(IEnumerable<EntityType> entities, out IEnumerable<EntityType> originalEntities);
        ...
        /// <param name="conditions"></param>
        /// <returns></returns>
        int UpdateEntities<EntityType>(UpdateSetClusters<EntityType> sets, Expression<Func<EntityType, bool>> conditions);
        #endregion
        ...
        /// <typeparam name="EntityType"></typeparam>
        /// <param name="id"></param>
        void DeleteEntity<EntityType>(object id);
        ...
        /// <typeparam name="EntityType"></typeparam>
        /// <param name="entity"></param>
        void DeleteEntity<EntityType>(EntityType entity);
        ...
        /// <typeparam name="EntityType"></typeparam>
        /// <param name="entities"></param>
        void DeleteEntities<EntityType>(IEnumerable<EntityType> entities);
        /// <summary>
        /// 删除符合条件的集合
        /// </summary>
        /// <typeparam name="EntityType"></typeparam>
        /// <param name="conditions"></param>
        void DeleteEntities<EntityType>(Expression<Func<EntityType, bool>> conditions);
        #endregion
        ...
        /// <param name="conditions"></param>
        /// <returns></returns>
        IEnumerable<EntityType> FindEntities<EntityType>(Expression<Func<EntityType, bool>> conditions);
        ...
        /// <typeparam name="EntityType"></typeparam>
        /// <returns></returns>
        IEnumerable<EntityType> FindEntities<EntityType>();
        #endregion
        ...
        /// <param name="id">主键值</param>
        /// <returns>返回主键对应的实体，不存在时返回null</returns>
        EntityType LoadEntity<EntityType>(object id);
        ...
        /// <param name="conditions"></param>
        /// <returns></returns>
        EntityType LoadEntity<EntityType>(Expression<Func<EntityType, bool>> conditions);
        #endregion
        #endregion
    }
}
